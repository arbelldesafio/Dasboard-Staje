export default async function handler(req, res) {
  try {
    ...
    const url = `https://script.google.com/macros/s/AKfycbyfxV8JYMaMZOjNo7OsCDVl3qU5PF9qUGTUZky5JFBXCnnn-97LCRn5RIqtD4Na4vo1/exec?email=${encodeURIComponent(email)}&contrasena=${encodeURIComponent(contrasena)}`;
