export default async function handler(req, res) {
  try {
    ...
    const url = `https://script.google.com/macros/s/AKfycbw7UcNdc0_jNQ0QL7gfsnAY6h4JzFEPAcIVReNLxeL33aM00qdoaeYIqVdtEDwMDlef/exec?email=${encodeURIComponent(email)}&contrasena=${encodeURIComponent(contrasena)}`;
