document.getElementById('loginForm').addEventListener('submit', async function (e) {
  ...
  const url = `https://script.google.com/macros/s/AKfycbyeY6q9_dioJc_3fRPujDjd1b-DksceLz3uvodXnICZpBSqufdll-kCs8ROUx0Juhb7/exec?email=${email}&contrasena=${contrasena}`;
